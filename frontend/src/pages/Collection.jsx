  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        ...
        <img src={images.arrow} alt="dropdown" className={`h-3 sm:hidden ${showFilters ?'rotate-90':'' }`}/>
        </p>
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-6 ${showFilters?'':'hidden'} sm:block `}> 
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            ...
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={'Bottomwear'} onChange={toggleSubCategory}/>Bottomwea
            </p>
            <p className='flex gap-2'>
